...
const LoginPage = () => {
    ...
    return (
        <div
            ...
            <div
                className="p-5 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.02),rgba(0,0,0,0.01))] z-60 shadow-xs shadow-black rounded-2xl max-w-auto w-full mx-[20%] sm:mx-[30%] md:mx-[35%] sm:px-3 sm:py-20">
                <form
                    className="flex flex-col justify-center items-center gap-40 text-black text-2xl font-bold font-serif text-center">
                    <h2
                    ...
                    <div className={"flex flex-col justify-center items-center gap-3 font-roboto"}>
                        ...
                        <button
                            ...
                            type="button"
                            id="login-btn"
                            className="flex justify-center items-center gap-5 border-2 border-black rounded-lg bg-gray-100 p-2 hover:bg-gray-200 hover:scale-105 transition-transform duration-200"
                        >
                            <Image
                                src="/google-logo.png"
                                alt="Google logo"
